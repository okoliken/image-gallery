...
declare const VueEasyLightbox: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "index" | "rtl" | "visible" | "loop" | "imgs" | "scrollDisabled" | "escDisabled" | "moveDisabled" | "titleDisabled" | "maskClosable" | "teleport" | "swipeTolerance">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $emit: ((event: "hide") => void) & ((event: "on-error", e: Event) => void) & ((event: "on-prev", oldIndex: number, newIndex: number) => void) & ((event: "on-next", oldIndex: number, newIndex: number) => void) & ((event: "on-prev-click", oldIndex: number, newIndex: number) => void) & ((event: "on-next-click", oldIndex: number, newIndex: number) => void) & ((event: "on-index-change", oldIndex: number, newIndex: number) => void);
        $el: any;
